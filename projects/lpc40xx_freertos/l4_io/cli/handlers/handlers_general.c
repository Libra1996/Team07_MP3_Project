...
// Watchdogs lab
app_cli_status_e cli__watchdogs_control(app_cli__argument_t argument, sl_string_s user_input_minus_command_name,
                                        app_cli__print_string_function cli_output) {
  sl_string_s s = user_input_minus_command_name;
...
app_cli_status_e cli__mp3_play(app_cli__argument_t argument, sl_string_s user_input_minus_command_name,
  ...
  xQueueSend(Q_songname, sl_string__c_str(s), portMAX_DELAY);
