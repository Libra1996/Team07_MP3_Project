...
void sj2_cli__init(void) {
  ...
  // Watchdogs lab
  static app_cli__command_s watchdogs_struct = {
      .command_name = "watchdogs", .help_message_for_command = "help", .app_cli_handler = cli__watchdogs_control};

  app_cli__add_command_handler(&sj2_cli_struct, &watchdogs_struct);
